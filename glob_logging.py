...
# Import the OTLPLogExporter class from the OpenTelemetry http log exporter module.
...
class CustomLogFW:
    ...
    def setup_logging(self):
        ...
        exporter = OTLPLogExporter(endpoint="http://172.31.161.14:30080/otlp/v1/logs", headers={"X-Scope-OrgID":"homelab"})
